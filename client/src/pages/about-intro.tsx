...
import { Mountain, Eye, HandHeart, Users, ChevronDown } from "lucide-react";
      ...
      <div className="main-bg min-h-screen">
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="text-center mb-16">
            <h1 className="text-4xl md:text-5xl font-bold text-center mb-4 text-gray-900 dark:text-white glow-text">
              Бидний тухай
            </h1>
          ...
          <section className="mb-20">
            ...
            <div className="relative">
              <div className="flex overflow-x-auto pb-4 space-x-8">
                {[
                  { year: '1965', title: 'Холбоо байгуулагдсан', description: 'Монголын ширээний теннисний холбоо анх байгуулагдав' },
                  { year: '1970', title: 'Эхний тэмцээн', description: 'Улсын хэмжээний анхны ширээний теннисний тэмцээн зохион байгуулав' },
                  { year: '1990', title: 'ITTF-д элссэн', description: 'Олон улсын ширээний теннисний холбооны гишүүн болсон' },
                  { year: '1993', title: 'Дэлхийн аварга', description: 'Анхны олон улсын тэмцээнд оролцов' },
                  { year: '1994', title: 'Азийн наадам', description: 'Азийн наадамд анх удаа оролцлоо' },
                  { year: '1996', title: 'Сургалтын төв', description: 'Үндэсний сургалтын төвийг байгуулсан' },
                  { year: '1997', title: 'Залуучуудын хөтөлбөр', description: 'Залуучуудын хөгжлийн хөтөлбөр эхэлсэн' },
                  { year: '1998', title: 'Эмэгтэйчүүдийн спорт', description: 'Эмэгтэйчүүдийн ширээний теннисийг хөгжүүлэх хөтөлбөр' },
                  { year: '2000', title: 'Олон улсын харилцаа', description: 'Өмнөд Солонгос, Хятадтай хамтын ажиллагаа эхэлсэн' }
                ].map((event) => (
