                  ...
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    {club.instagram && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="w-8 h-8 rounded-full bg-gradient-to-tr from-yellow-400 via-red-500 to-purple-500 hover:opacity-80 flex items-center justify-center transition-colors"
