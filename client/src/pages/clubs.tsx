...
import { MapPin, Globe, Phone, Mail, Clock, Grid3x3, Search, ChevronDown } from 'lucide-react';
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
                  ...
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    {club.instagram && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="w-7 h-7 rounded-full bg-gradient-to-tr from-yellow-400 via-red-500 to-purple-500 hover:opacity-80 flex items-center justify-center transition-colors"
